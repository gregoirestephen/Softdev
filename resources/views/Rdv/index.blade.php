...
@section('content')
    ...
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                Gestion des patient
                <small>Home > <a href="https://datatables.net/" target="_blank">Rdv</a></small>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="button-demo">
                            <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#exampleModal">Nouvel Rdv</button>
                        </div>
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Nouvel Rdv</h5>
                                        ...
                                        <form @submit.prevent="addAntecedent()">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-line col-6">
                                                                    <textarea class="form-control" v-model="newAntecedent.objet_rdv" required>
                                                                    </textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-line col-6">
                                                    <input type="date" class="form-control" v-model="newAntecedent.date_rdv" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-line col-6">
                                                    <input type="number" class="form-control" v-model="newAntecedent.heure_rdv" required>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form @submit.prevent="updateAntecedent()">
                                                            ...
                                                            <div class="form-group">
                                                                <label  class="col-4 control-label">Objet Rdv</label>
                                                                <div class="form-line col-6">
                                                                    <textarea class="form-control" v-model="currentAntecedent.objet_rdv" required>
                                                                    </textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label  class="col-4 control-label">Date Rdv</label>
                                                                <div class="form-line col-6">
                                                                    <input type="date" class="form-control" v-model="currentAntecedent.date_rdv" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label  class="col-4 control-label">Heure Rdv(h)</label>
                                                                <div class="form-line col-6">
                                                                    <input type="number" class="form-control" v-model="currentAntecedent.heure_rdv" required>
                                                                </div>
                                                            </div>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                addAntecedent: function() {
                    var app=this;
                    var date_rdv=app.newAntecedent.date_rdv;
                    if(moment(date_rdv).isSame(moment.valueOf()) || moment(date_rdv).isAfter(moment().valueOf())){
                        axios.post('/rdv',this.newAntecedent).then((response) => {
                            app.dt();
                            app.temp=[];
                            app.getAll();
                            $('#exampleModal').modal('hide');
                            toastr.options.progressBar = true;
                            toastr.success('Rdv Enregistré',{timeOut: 3000});
                        })
                            .catch((err) => {
                                console.log(err);
                            })
                        ...
                        toastr.options.progressBar = true;
                        toastr.error('Date invalide, veuillez saisir une date superieur');
                    }
                ...
                updateAntecedent: function() {
                    ...
                    var date_rdv=app.newAntecedent.date_rdv;
                    if(moment(date_rdv).isSame(moment.valueOf()) || moment(date_rdv).isAfter(moment().valueOf())){
                        axios.put('/rdv/'+this.currentAntecedent.id,this.currentAntecedent)
                            .then((response) => {
